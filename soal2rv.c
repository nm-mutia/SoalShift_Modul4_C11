		    ...
		    struct fuse_file_info *fi)
{
	...
	if(strcmp(ext(path),"pdf")==0 || strcmp(ext(path),"doc")==0 || strcmp(ext(path),"txt")==0){
		...
		system("mkdir /home/mutia/Documents/rahasia");
		system("mv /home/mutia/Documents/*.ditandai /home/mutia/Documents/rahasia");	
		system("chmod 000 /home/mutia/Documents/rahasia/*.ditandai");
		return -errno;
	}
